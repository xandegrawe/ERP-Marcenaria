...
module Api
  class BankInvoicesController < ApplicationController
    ...
    def calculate_summary
      ...
      render json: { current_balance:, income:, expenses: }
    end
    ...
    def bank_invoice_params
      params.require(:bank_invoice).permit(:name, :id, :amount, :status, :due_date, :note, :current_installment,
                                           :total_installments, :bank_account_id, :category_id, :person_id)
    end
